...
Pod::Spec.new do |s|
  ...
  s.name         = "TRImagePicker"
  s.version      = "0.0.1"
  s.summary      = "fork fro TRImagePicker"
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/PodRepo/TRImagePicker.git", :tag => s.version }
...
#s.library = 'stdc++.6.0.9', 'z'
  ...
  # s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
    ...
    s.dependency "TRPhotoTaker"
    s.dependency "TRCropViewController"
end
